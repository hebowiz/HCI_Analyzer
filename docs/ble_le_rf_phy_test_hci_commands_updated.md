...
| 49 | 0 | `HCI_Read_Local_Supported_Commands [v2]` |
...
5. GUIや送信ツールでは、bitmaskに基づき未対応コマンドをdisableまたは警告表示する
```

### 9.7 implementation specific な事項
...
## 10. Supported Commands での確認ポイント
